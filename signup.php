...
<body class="h-full px-4 md:px-16 pb-16">
    <h3 class="text-3xl font-bold leading-6 text-center text-gray-900 py-8">Register</h3>
        ...
        <div class="overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <button type="submit" class="inline-flex justify-center py-2 px-8 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Register</button>
                </div>
                </div>
            </div>
        </div>
